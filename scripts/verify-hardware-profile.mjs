...
for (const file of files) {
  ...
  if (!p.ros?.topics || typeof p.ros.topics !== 'object' || !Object.keys(p.ros.topics).length)
    fail('ros.topics required');
  ...
  if (!['diff-drive', 'omni-drive', 'joint', 'custom'].includes(p.actuator?.kind))
